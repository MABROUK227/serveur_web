...
<h3>Veuillez vérifier toutes les informations de votre commande avant de payer !</h3>
	<h4>En cas d'erreur ou si vous fournissez des informations invalides, votre commande ne pourra pas être traitée.</h4>

	<br>
	<h5>Tes informations</h5>
	<ul class="list-group">
